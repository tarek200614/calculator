...
| Key | Action |
|---|---|
| <kbd>0</kbd> – <kbd>9</kbd> | Enter numbers |
| <kbd>.</kbd> | Decimal point |
| <kbd>+</kbd> | Addition |
| <kbd>-</kbd> | Subtraction |
| <kbd>*</kbd> | Multiplication |
| <kbd>/</kbd> | Division |
| <kbd>%</kbd> | Modulo / percentage operator |
| <kbd>(</kbd> <kbd>)</kbd> | Parentheses |
| <kbd>Enter</kbd> | Calculate |
| <kbd>Escape</kbd> | Clear calculator |
...
- GitHub: [https://github.com/tarek200614](https://github.com/tarek200614)
- LinkedIn: [https://www.linkedin.com/in/abderrahmane-tarek-meghari](https://www.linkedin.com/in/abderrahmane-tarek-meghari)
